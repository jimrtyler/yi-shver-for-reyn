...
#GUI Variables
$FormTitleText = "דיסק קלינער דורך Jim Tyler (PowerShellEngineer.com)"
$SelectDiskLabelText = "אויסקלײַבן דיסק:"
$FreeSpaceLabelText = "פריי פּלאַץ (גיגאבייט):"
$TotalSpaceLabelText = "גאַנץ פּלאַץ (גיגאבייט):"
$JunkFoundLabelText = "אָפּפאַל געפונען (גיגאבייט):"
$CleanDiskBtnText = "ריין דיסק *מעקן טעקעס*"
$SpaceCleanedLabelText = "רייניקט פּלאַץ (גיגאבייט):"
$LogFileLabelText = "לאָג טעקע געפונען: $abcdefg"
$CreditLabelText = "שריפט פון Jim Tyler - PowerShellEngineer.com"
$LogFileLocatedText = "לאָג טעקע געפונען"
$AnalyzingDriveText = "אַנאַליזירן דרייווז..."
$BrowsersAreRunningText = "בלעטערערס לויפן... געבנ צו וויסן באַניצער..."
$PleaseCloseBrowsersText = "ביטע פאַרמאַכן אַלע וועב בראַוזערז און פּרובירן ווידער."
$CleaningDriveText = "רייניקן דרייוו..."
